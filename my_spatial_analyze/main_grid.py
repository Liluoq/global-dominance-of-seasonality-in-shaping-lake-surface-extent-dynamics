...
if __name__ == '__main__':
    ...
    output_grid_pkl_path = f'/data/grid_{basin_id}.pkl'
    ...
    if TIME_SERIES_ANALYSIS_AT_GRID_SCALE:
        ...
        analyzed_gdf_path = f'/data/grid_{basin_id}.pkl'
    if TIME_SERIES_ANALYSIS_AT_GRID_SCALE:
    ...
    if VISUALIZATION:
        ...
        save_path = '/results/Supplementary_Fig_4_raw.pdf'
