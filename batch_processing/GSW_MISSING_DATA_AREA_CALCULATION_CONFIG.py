...
OUTPUT_CSV_FOLDER = f'area_csvs/gsw_missing_data_area/{BASIN_ID}'
OUTPUT_CSV_FILE_NAME_PATTERN = '{basin_id}_{start_date}_{end_date}_gsw_missing_data_area.csv'
OUTPUT_CONCATENATED_CSV_PATH = f'area_csvs/gsw_missing_data_area_concatenated/{BASIN_ID}_gsw_missing_data_area_concatenated.csv'
