"""Update the configuration file and run the evaluation script for each basin.

This script updates the configuration file with the HYBAS_ID and FINAL_DECISION,
then runs the evaluation script for each basin.
"""
