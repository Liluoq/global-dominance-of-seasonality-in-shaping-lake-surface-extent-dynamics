...
def residualunet(input_shape, dropout=0.2, batchnorm=True):
    ...
    # upsampling layers
    up_conv6 = layers.Conv2DTranspose(filters[3], (3, 3), strides=(2, 2), padding="same")(dn_conv5)
    ...
    up_conv7 = layers.Conv2DTranspose(filters[2], (3, 3), strides=(2, 2), padding="same")(up_conv6)
    ...
    up_conv8 = layers.Conv2DTranspose(filters[1], (3, 3), strides=(2, 2), padding="same")(up_conv7)
    ...
    up_conv9 = layers.Conv2DTranspose(filters[0], (3, 3), strides=(2, 2), padding="same")(up_conv8)
