...
This configuration file defines the parameters for training a U-Net model.
It includes settings for the basin ID, sample patterns, local sample folder,
input bands, scaling factors, response variables, kernel size, epochs, batch size,
and output folder.
"""
