"""Generate a mosaic of GSW occurrence and recurrence tiles for each basin.

This script generates a mosaic of GSW occurrence and recurrence tiles for each basin.
It uses the mosaic_tiles function from my_unet_gdal.reproject_to_target_tile to create the mosaic.
"""
import os
